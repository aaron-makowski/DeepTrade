...
class A2CAgent(Agent):
    ...
    def train(self,
        ...
        n_episodes: int = kwargs.get('n_episodes', 1)
        save_path = kwargs.get('save_path', None)
        render_interval = kwargs.get('render_interval', None)  # in steps, None for episode end

        #For Streamlit caching hashing
        ...
        # Loop through all training episodes
        while episode < n_episodes:
            ...
            while not done:
                ...
                #Progress Bar
                txt.subheader(f'{steps_done+1}/{n_steps} Steps Done [Episode {episode+1}/{n_episodes}]')
                bar.progress(int(steps_done / n_steps * 100))
                ...
                if render_interval and (steps_done % render_interval == 0 or done):
            ...
            if save_path and (is_checkpoint or done):
    ...
    def one_live_run(self):
        self.env.reset()

        # Artificially advance environment to last step
        ...
        return self.env._broker.trades